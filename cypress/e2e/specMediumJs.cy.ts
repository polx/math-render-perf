describe('Medium JS - Verify All Elements', () => {
  it('Measure time for JS Medium Component', () => {
    cy.clearCookies();
    ...
    cy.visit('http://localhost:4000/mathJaxJs/medium'); // Update this with the correct URL
