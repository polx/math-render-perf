describe('Small ML - Verify All Elements', () => {
  it('Measure time for ML Small Component', () => {
    cy.clearCookies();
    ...
    cy.visitAsHtml('http://localhost:4000/mathML/small'); // Update this with the correct URL
