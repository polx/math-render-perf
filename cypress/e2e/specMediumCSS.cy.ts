describe('Medium CSS - Verify All Elements', () => {
  it('Measure time for CSS Medium Component', () => {
    cy.clearCookies();
    ...
    cy.visitAsHtml('http://localhost:4000/mathJaxCss/medium'); // Update this with the correct URL
