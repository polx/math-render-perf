describe('Large ML - Verify All Elements', () => {
  it('Measure time for ML Small Large', () => {
    cy.clearCookies();
    ...
    cy.visitAsHtml('http://localhost:4000/mathML/large'); // Update this with the correct URL
