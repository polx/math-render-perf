describe('Medium SVG - Verify All Elements', () => {
  it('Measure time for SVG Medium Component', () => {
    cy.clearCookies();
    ...
    cy.visitAsHtml('http://localhost:4000/mathJaxSvg/medium'); // Update this with the correct URL
